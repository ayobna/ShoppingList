...
import { ShoppinglistApi, ProductApi, UserApi, Configuration, ChatApi, RequestsApi ,ListUsersApi } from '../generated';
...
export { userApi, shoppingListApi, productApi, chatApi,requestApi,listUsersApi, API };